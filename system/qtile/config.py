...
#-:-------------------------------------------------------------------------:-#
    ...
    Key([mod, "shift"], "t", lazy.spawn("cool-retro-term -e bpytop")),
...
[
    ...
    widget.Volume(foreground = colors[2],background = colors[4],fmt = 'Volume: {}',padding = 5),
    widget.TextBox(background = colors[4], text=":"),
